...
package com.example.infoquakes.ui.map;
...
//this is the activity where we show all records on a map.
//records are stored in a list that is mFeedModelList
...
public class MapFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        //all records are stored in mFeedModelList
        //it places markers on each of the longlat of each record stored in list named mFeedModelList
